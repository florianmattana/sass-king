// 15i_qmma_e3m2_e2m3_latency.cu
//
// Serial latency microbenchmark for mixed FP6 E3M2 x E2M3 QMMA.
...
int main(void) {
    ...
    for (int i = 0; i < n_a; ++i) h_a[i] = 0xffffffffu;
    ...
    printf("N=%d total_cycles=%llu cycles_per_qmma=%.2f d[0]=%.8e\n", N_QMMA, h_cycles, (double)h_cycles / N_QMMA, h_d[0]);
