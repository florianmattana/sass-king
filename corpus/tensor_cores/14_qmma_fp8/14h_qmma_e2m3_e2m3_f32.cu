// 14h_qmma_e2m3_e2m3_f32.cu
//
// Chapter 14 variant h. QMMA with FP6 e2m3 inputs (alternative FP6 to E3M2).
// Same shape (m16n8k32), accumulator (FP32). Purpose: identify whether E2M3
// shares control code bits with E3M2 (same FP6 family) or has its own bits.
//
// Matches CUTLASS SM120_16x8x32_TN<float_e2m3_t, float_e2m3_t, float>
// from mma_sm120.hpp (line 464).
//
// Same approach as 14g: use zero inputs to sidestep the FP6 packing question.
// The SASS observation (opcode, control code) is independent of input values.
//
// Compile: nvcc -arch=compute_120a -code=sm_120a -o 14h_qmma_e2m3_e2m3_f32 14h_qmma_e2m3_e2m3_f32.cu
// Dump:    cuobjdump --dump-sass 14h_qmma_e2m3_e2m3_f32 > 14h_qmma_e2m3_e2m3_f32.sass
...
__global__ void qmma_e2m3_e2m3_f32_kernel(
...
int main(void) {
    ...
    // Zero inputs for deterministic output. SASS observations independent of values.
    ...
    qmma_e2m3_e2m3_f32_kernel<<<1, 32>>>(d_a, d_b, d_c, d_d);
